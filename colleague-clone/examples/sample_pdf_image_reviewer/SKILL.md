---
name: colleague-pdf-image-reviewer
description: Draft colleague clone for PDF Image Reviewer
user-invocable: true
---
...
- Scope modules: Owner, alignment, and, code, error
- Operating sequence: clarify, align_owner, risk_first, checklist
- Review focus: error code
- Confidence: 0.65
...
- Default modules: Owner, alignment, and, code, error
- Default review focus: error code
- Workflow sequence: clarify, align_owner, risk_first, checklist
...
## Domain Knowledge
- Terms: owner, alignment, code, error, first, impact, review
