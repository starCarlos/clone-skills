#!/usr/bin/env python3
"""Validate consistency across workflow runtime manifest and README."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate workflow runtime dispatch consistency.")
...
def main() -> int:
    ...
    report = {
        ...
        "ok": manifest_command == readme_command and not missing_fields,
    }
